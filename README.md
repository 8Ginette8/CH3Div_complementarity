...
[![DOI](https://zenodo.org/badge/999507518.svg)](https://doi.org/10.5281/zenodo.20538980)
...
#### Input data
Calculating the complementarity indicator (CI) was dependent on species habitat suitability maps derived from the [SDMapCH](https://doi.org/10.1038/s41597-025-06037-x) dataset. **Data is natively at 25 x 25 m resolution**, however, for example feasibility and copyright reason, the available data was uploaded on GitHub at **10 x 10 km resolution**.
...
Also note that **v1.0** of the [TraitCH](https://doi.org/10.5281/zenodo.15063844) dataset was here used. **v2.0** is now available following the same link at [Zenodo](https://doi.org/10.5281/zenodo.15063844).
