...
> *Spatial distribution of the complementarity biodiversity indicator (CI) across Switzerland. Higher values indicate higher pixel contributions for overall complementarity, lower values imply larger importance.*
